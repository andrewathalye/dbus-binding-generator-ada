...
begin
   ...
   OFD.RequestName (To_Unbounded_String ("tk.zenithseeker.dbusbinder"), 0, U32);
   Put_Line (U32'Image);

   OFD.ReleaseName (To_Unbounded_String ("org.freedesktop.DBus.B"), U32);
   Put_Line (U32'Image);

   OFD.GetConnectionCredentials (To_Unbounded_String ("tk.zenithseeker.dbusbinder"), DSV);
   Put_Line (DSV'Image);
   ...
   OFD.GetAdtAuditSessionData (To_Unbounded_String ("tk.zenithseeker.dbusbinder"), AY);
   Put_Line (AY'Image);
end DBus;
